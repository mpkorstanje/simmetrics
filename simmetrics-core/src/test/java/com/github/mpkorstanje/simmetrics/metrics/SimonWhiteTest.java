...
import static com.github.mpkorstanje.simmetrics.tokenizers.Tokenizers.filter;
import static com.github.mpkorstanje.simmetrics.tokenizers.Tokenizers.qGram;
...
import com.github.mpkorstanje.simmetrics.MultisetDistanceTest;
import com.github.mpkorstanje.simmetrics.MultisetMetric;
import com.github.mpkorstanje.simmetrics.MultisetMetricTest;
...
final class SimonWhiteTest  {
	...
	static final class DistaneTest extends MultisetDistanceTest {
		...
		private static Tokenizer q2() {
			return chain(asList(filter(whitespace(), minimumLength),
					qGram(2)));
		}
	...
	static final class MetricTest extends MultisetMetricTest {
		...
		private static Tokenizer q2() {
			return chain(asList(filter(
					whitespace(), minimumLength), qGram(2)));
		}
