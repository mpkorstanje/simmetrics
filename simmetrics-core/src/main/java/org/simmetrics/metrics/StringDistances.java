...
public final class StringDistances {
	...
	public static StringDistance cosineSimilarity() {
		return with(new CosineSimilarity<>()).tokenize(whitespace()).build();
	}
	...
	public static StringDistance euclideanDistance() {
		return with(new EuclideanDistance<>()).tokenize(whitespace()).build();
	}
	...
	public static StringDistance generalizedJaccard() {
		return with(new GeneralizedJaccard<>()).tokenize(whitespace()).build();
	}
	...
	public static StringDistance overlapCoefficient() {
		return with(new OverlapCoefficient<>()).tokenize(whitespace()).build();
	}
	...
	public static StringDistance qGramsDistance() {
		return with(new BlockDistance<>()).tokenize(qGramWithPadding(3)).build();
	}
