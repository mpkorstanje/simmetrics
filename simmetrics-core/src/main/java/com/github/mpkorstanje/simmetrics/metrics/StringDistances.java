...
public final class StringDistances {
	...
	public static StringDistance cosineSimilarity() {
		return with(new CosineSimilarity<>()).tokenize(Tokenizers.whitespace()).build();
	}
	...
	public static StringDistance blockDistance() {
		return with(new BlockDistance<>()).tokenize(Tokenizers.whitespace()).build();
	}
	...
	public static StringDistance dice() {
		return with(new Dice<>()).tokenize(Tokenizers.whitespace()).build();
	}
	...
	public static StringDistance euclideanDistance() {
		return with(new EuclideanDistance<>()).tokenize(Tokenizers.whitespace()).build();
	}
	...
	public static StringDistance generalizedJaccard() {
		return with(new GeneralizedJaccard<>()).tokenize(Tokenizers.whitespace()).build();
	}
	...
	public static StringDistance jaccard() {
		return with(new Jaccard<>()).tokenize(Tokenizers.whitespace()).build();
	}
	...
	public static StringDistance overlapCoefficient() {
		return with(new OverlapCoefficient<>()).tokenize(Tokenizers.whitespace()).build();
	}
	...
	public static StringDistance qGramsDistance() {
		return with(new BlockDistance<>()).tokenize(Tokenizers.qGramWithPadding(3)).build();
	}
